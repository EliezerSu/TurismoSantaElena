        ...
        <div style="background-color: #082032;" class="container-fluid">
            ...
            <div style="background-color: #082032;" class="collapse navbar-collapse" id="menu">
                <ul style="background-color: #082032;" class="navbar-nav d-flex mx-auto  text-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="la_entrada.php">Acerca de</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="quevisitar_la_entrada.php">¿Qué visitar?</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-secondary text-center" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item font__size" href="cultura_laentrada.php">Culturas y tradiciones</a>
                            <li>
                            <li><a class="dropdown-item font__size" href="gastronomia_laentrada.php">Gastronomía</a>
                            <li>
