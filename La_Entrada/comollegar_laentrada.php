<?php include("head_la_entrada.php");?>
    ...
    <img src="imagenes/la_entrada/como_viajar/0620__como_llegar_1.jpg" class="card-img" alt="..." style="width: 100%; height: 70vh;">

      <div class="card-img-overlay">
        
        <p class="card-text texto__banner2 text-shadow display-2 text-center text-responsive" >¿Cómo llegar?</p>
...
<section class="mb-4 col-10 w-75  text-sm-center mx-auto" >
  <p class="texto__llegar   mx-auto" style="font-size: 20px; ">
    Conoce más sobre cómo llegar a La Comuna La Entrada y Rinconada en los
    diferentes medios de transporte, de esta manera estarás preparado para una nueva
    aventura.
  </p>
  <div class="tabs-custom tabs-horizontal wow fadeInRight tabs-line mx-auto w-50" id="tabs-4"><ul  style="border-bottom: 3px solid #01b3a7; "  >

    <li><h2 style="text-align: center;color:#122638" class="como__llegar__entrada mx-auto">Aerolineas</h2></li>
    </ul>
  </div>
    <div class="text-center wow fadeInRight">
      <i class="fa-sharp fa-solid fa-6x mt-5 fa-plane-up"></i>
    </div>
</section>
 <!--Aereolíneas-->
 <section>
        ...
        <div class="container-card wow fadeInRight">
        <div class="cards col-3 mx-auto ">
                <div class="contenido-card">
                    <h3><b>Equair</b></h3><br>
                    <p class="mb-5">
                    Centro de contacto: 1800- 
                    equair 
                    <br> 0963871680     
                    </p>
                    <a href="https://www.latamairlines.com/ec/es" class="mt-4" target="_blank">Visitar</a>
    ...
    <section>
        <div class="tituloPrincipal wow fadeInRight" style="text-align:center;">
            ...
            <div class="text-center">
              <i class="fa-solid fa-6x fa-car"></i>
            </div>
        </div>
        <div class="container-card wow fadeInRight">
            <div class="cards">
...
<section class="wow fadeInRight">
  <div class="tabs-custom tabs-horizontal tabs-line mx-auto w-50 mt-5 mb-5" id="tabs-4"><ul  style="border-bottom: 3px solid #01b3a7; "  >

  <li><h2 style="text-align: center;color:#122638" class="como__llegar__entrada mx-auto">Transporte público</h2></li>
  </ul>
  </div>
  ...
  <div class="row text-center">
    ...
    <div class="col-sm-4 mx-auto text-center">
      <i class="fa-solid fa-bus fa-4x icono-flex d-block text-center "></i>
      <div class="card cards mt-4 mb-4">
     
        <div class="card-body cuerpo-tarjeta cuerpo-tarjeta">
         
          <p class="card-text">
          <b>▪ Terminal de
            Guayaquil</b> <br>
            <b>Cooperativa CLP</b>  <br>
            • Guayaquil a
            Montañita/ Pasaje -
            $6,25 <br>
            • Montañita a
            ...
            <b>▪ Terminal de Santa
            Elena </b> 
          <b>Cooperativa Manglaralto,
            Reales Tamarindo.</b>  <br>
            Costo del pasaje $ 2,25
            Duración:1h30m 
...
<section class= "wow fadeInRight">
  <p class="texto__llegar clead mb-4 col-8 mx-auto" style="font-size: 20px; ">
    ...
    supermercados que podrás encontrar en las comunas La Entrada y La Rinconada, de tal
    manera estarás informado sobre todo lo importante que necesitas para tu visita.
  </p>
</section>
<section class= "wow fadeInRight">
  <div class="iconos-flex d-flex d-sm-flex">
  ...
  <div class="row ">
    ...
    <div class="col-sm-4 mx-auto text-center">
      ...
      <div class="card cards mt-4 mb-2">
    ...
    <div class="col-sm-4 mx-auto text-center">
      ...
      <div class="card cards mt-4 mb-4 w-75">
    ...
    <div class="col-sm-3 mx-auto text-center tarjeta">
        
   
      <div class="card cards mt-4 mb-4">
        <i class="fa-solid fa-cart-shopping fa-4x icono-flex d-block"></i>
        
        <div class="card-body">
          <h5 class="card-title">Supermercados</h5>
          <p class="card-text">
          Hiper Market Center Aki <br>
          Minimarket Nayelita <br>
