      ...
      <div class="row row-50 justify-content-center align-items-xl-center">
        <div class="col-md-10 col-lg-5 col-xl-6">
          <div>
            <ul>
              <li>
                <a href="../PaginaValoraciones.php?img=ancon/imagenes/ancon/0026_gastronomia.jpg">
                <img src="imagenes/ancon/0026_gastronomia.jpg" alt="" width="519" height="564"/>
                </a>
              </li>
            </ul>
          </div>
  ...
  <div class="imagenes">
      <div class="galeria">         
          ...
          <div class="contenedor-imagenes">
              <div class="imagen">
                <a href="../PaginaValoraciones.php?img=ancon/imagenes/ancon/0027_gastronomia.jpg">
                  <img src="imagenes/ancon/0027_gastronomia.jpg" alt="">
                  <div class="overlay">
                      <h2>Ceviche mano de Dios</h2>
                  </div>
                </a>
              </div>
              <div class="imagen">
                <a href="../PaginaValoraciones.php?img=ancon/imagenes/ancon/0028_gastronomia.jpg">
                  <img src="imagenes/ancon/0028_gastronomia.jpg" alt="">
                  <div class="overlay">
                      <h2>Ensalada con camarones</h2>
                  </div>
                </a>
              </div>
              <div class="imagen">
                <a href="../PaginaValoraciones.php?img=ancon/imagenes/ancon/0029_gastronomia.jpg">
                  <img src="imagenes/ancon/0029_gastronomia.jpg" alt="">
                  <div class="overlay">
                      <h2>Menú</h2>
                  </div>
                </a>
