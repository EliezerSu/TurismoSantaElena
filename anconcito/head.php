...
$texto_traducido = GetTextoTraducido("../language/anconcito");
?>
<!DOCTYPE html>
            ...
            <div style="background-color: #082032;" class="container-fluid">
                ...
                <div style="background-color: #082032;" class="collapse navbar-collapse" id="menu">
                    <ul style="background-color: #082032;" class="navbar-nav d-flex mx-auto justify-content-between text-center">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="anconcito.php"><?php echo $texto_traducido["header"][0] ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="quevisitaranconcito.php"><?php echo $texto_traducido["header"][1] ?></a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-secondary text-center" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="desportesanconcito.php"><?php echo $texto_traducido["header"]["subtitle-1"][0] ?></a>
                                </li>
                                <li><a class="dropdown-item" href="culturaanconcito.php"><?php echo $texto_traducido["header"]["subtitle-1"][1] ?></a>
                                <li>
                                <li><a class="dropdown-item" href="gastronomiaanconcito.php"><?php echo $texto_traducido["header"]["subtitle-1"][2] ?></a>
                                <li>
                                <li><a class="dropdown-item" href="rutasanconcito.php"><?php echo $texto_traducido["header"]["subtitle-1"][3] ?></a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-secondary text-center" aria-labelledby="navbarDropdown">
                                <!-- <li><a class="dropdown-item" href="comollegaranconcito.php"><?php echo $texto_traducido["header"]["subtitle-1"][4] ?></a>
                                </li> -->
                                <li><a class="dropdown-item" href="hotelesanconcito.php"><?php echo $texto_traducido["header"]["subtitle-1"][5] ?></a>
                                <li>
                                <!-- <li><a class="dropdown-item" href="itinerariosanconcito.php"><?php echo $texto_traducido["header"]["subtitle-1"][6] ?></a>
                                </li> -->
                                <li><a class="dropdown-item" href="tiempoanconcito.php"><?php echo $texto_traducido["header"]["subtitle-1"][7] ?></a>
                                </li>
                            </ul>
                        </li>
                        <li class="d-flex">
