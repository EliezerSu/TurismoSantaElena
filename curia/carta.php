<section>
    <br>
        <h3 class="titulocarta" style="margin-top: 40px; margin-bottom: 0; color: #162e44; " >¿Qué hacer?</h3>
    <br>
    <div class="linea01"></div>
        <div id="contenedor">
            <div class="tabla">
                ...
                <p>Vive una experiencia de turísmo deportivo activo...</p>
                <a href="deportes.php" class="boton">Ver Más</a>
            </div>
            <div class="tabla">
                <img src="imagenes\curia\0498_eleccionreina_1.jpg" alt="">
                <h3>Culturas y Tradiciones</h3>
                <p>Acércate a una experiencia transformadora...</p>
                <a href="cultura.php" class="boton">Ver Más</a>
            </div>
            <div class="tabla">
                <img src="imagenes\curia\0527_restdonvicente_reservayexperiencia.jpg" alt="">
                <h3>Gastronomía</h3>
                <p>Deleite sus sentidos con el color y sabor de nuestros platillos...</p>
                <a href="gastronomia.php" class="boton">Ver Más</a>
            </div>
        </div>
    </div>
</section>
