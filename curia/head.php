...
$texto_traducido = GetTextoTraducido("../language/curia");
?>
<!DOCTYPE html>
      ...
      <div style="background-color: #082032;" class="container-fluid">
        ...
        <div style="background-color: #082032;" class="collapse navbar-collapse" id="menu">
          <ul style="background-color: #082032;" class="navbar-nav d-flex mx-auto justify-content-between text-center">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="curia.php"><?php echo $texto_traducido["header"][0] ?></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="CuriaQueVisitar.php"><?php echo $texto_traducido["header"][1] ?></a>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu bg-secondary text-center" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="como_llegar_curia.php"><?php echo $texto_traducido["header"]["subtitle-1"][4] ?></a></li>
                <!-- <li><a class="dropdown-item" href="quedarse_curia.php"><?php echo $texto_traducido["header"]["subtitle-1"][5] ?></a> -->
                <li>
                <li><a class="dropdown-item" href="exemples\Triptico_Folleto_Comuna_Curia.pdf" target="_blank"><?php echo $texto_traducido["header"]["subtitle-1"][6] ?></a></li>
