    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $user_sexo = mysqli_real_escape_string($con,(strip_tags($_POST["cbo_sexo"],ENT_QUOTES)));
                $user_pais = mysqli_real_escape_string($con,(strip_tags($_POST["pais"],ENT_QUOTES)));
                ...
                $sql = "SELECT * FROM Usuarios WHERE username = '" . $user_name . "' OR correo = '" . $user_email . "';";
                ...
                if ($query_check_user == 1) {
                    ...
                    $estado=1;
                    $sql = "INSERT INTO Usuarios (nombre_completo, username, clave, fecha_nacimiento, correo, sexo, id_pais, estado, fecharegistro)
                            VALUES('".$firstname."','" . $user_name . "', '" . $user_password_hash . "','".$fechanac."', '" . $user_email . "','".$user_sexo."','".$user_pais."','".$estado."','".$date_added."');";
