  ...
  <div>
      ...
      <section class="section swiper-container swiper-slider swiper-slider-corporate swiper-pagination-style-2" data-loop="true" data-autoplay="5000" data-simulate-touch="true" data-nav="false" data-direction="vertical">
        <div class="swiper-wrapper text-left">
          <div class="swiper-slide context-dark" data-slide-bg="imagenes/sanjose/0294_portada001.jpg">
          ...
          <div class="swiper-slide context-dark" data-slide-bg="imagenes/sanjose/0295_portada002.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
          ...
          <div class="swiper-slide context-dark" data-slide-bg="imagenes/sanjose/0296_portada004.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
...
<div style="width:100%;background-color: rgba(8, 32, 50,.9); padding:15px 25px">
    <a style=" font-size:18px; color:white;display:flex; justify-content:center;" href="../index.php">Inicio </a>
      ...
      <div class="px-4 py-5 my-5 text-center container-fluid" >
              <h2 style="text-align: center;color:#122638">San José</h2>
    ...
    <!--carta-->
    <div >
     <?php include("cartasanjose.php");?>
     </div>
     
      <section class="section bg-default text-center offset-top-50">
        <div class="parallax-container" data-parallax-img="imagenes\sanjose\0298_san_jose.jpeg">
        ...
        <div class="container-fluid">
          ...
          <div class="owl-carousel owl-classic owl-dots-secondary" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="4" data-xl-items="5" data-xxl-items="6" data-stage-padding="15" data-xxl-stage-padding="0" data-margin="30" data-autoplay="true" data-nav="true" data-dots="true">
            ...
            <article class="thumbnail thumbnail-mary">
              <div  class="thumbnail-mary-figure"><a href="sanjosemurales.php"><img src="imagenes/sanjose/0343_murales_san_jose.jpg" alt=""/></a>
              </div>
              
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div  class="thumbnail-mary-figure"><a href="sanjosefiestaspatronales.php"><img src="imagenes/sanjose/0344_fiestas_patronales.jpg" alt="" width="270" height="195"/></a>
              </div>
              
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div  class="thumbnail-mary-figure"><a href="sanjoserio.php"><img src="imagenes/sanjose/0345_rio_de_san_jose.jpg" alt="" width="270" height="195"/></a>
              </div>
              
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div class="thumbnail-mary-figure"><a href="sanjosecapilla.php"><img src="imagenes/sanjose/0347_capilla_catolica_san_jose.jpg" alt="" width="270" height="195"/></a>
              </div>              
            </article>
            <!-- Thumbnail Classic-->
            <article class="thumbnail thumbnail-mary">
              <div  class="thumbnail-mary-figure"><a href="sanjoseplaya.php"><img src="imagenes/sanjose/0346_playa_san_jose.jpg" alt="" width="270" height="195"/></a>
              </div>              
            </article>
          </div>
        </div>
