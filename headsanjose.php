...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <style>.ie-panel{display: none;background: #212121;padding: 10px 0;box-shadow: 3px 3px 5px 0 rgba(0,0,0,.3);clear: both;text-align:center;position: relative;z-index: 1;} html.ie-10 .ie-panel, html.lt-ie-10 .ie-panel {display: block; }     #psw ,
    #contrasenia{
    ...
    padding-left: 32px;" class="container-fluid">
        ...
        <div style="background-color: #082032;" class="collapse navbar-collapse" id="menu">
            <ul style="background-color: #082032;" class="navbar-nav d-flex mx-auto justify-content-between text-center">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="sanjoseacercade.php">Acerca de</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="sanjosequevisitar.php">¿Qué Visitar?</a>
                </li>
            

                <li class="nav-item dropdown ">
                    <a class="nav-link "  href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"  >¿Qué Hacer?
                    </a>


                    <ul class="dropdown-menu bg-secondary text-center " aria-labelledby="navbarDropdown">
                        
                        <li><a class="dropdown-item " href="sanjosecultura.php">Culturas y tradiciones</a>
                        <li>
                        <li><a class="dropdown-item " href="sanjosegastronomia.php">Gastronomía</a>
                        <li>
                        <li><a class="dropdown-item " href="sanjoserutas.php">Rutas y excursiones</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu bg-secondary text-center " aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item " href="sanjosecomollegar.php">¿Cómo llegar?</a></li>
                        <li><a class="dropdown-item " href="sanjosequedarse.php">¿Dónde Alojarse?</a>
                        <li>
                        <li><a class="dropdown-item " href="sanjoseitinerario.php">Itinerario</a></li>
                        <li><a class="dropdown-item " href="tiemposanjose.php">Tiempo</a></li>
                    </ul>
                </li>
            </ul>
