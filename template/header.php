...
<head>
  ...
  <link rel="stylesheet" href="css/leyendas_atractivos.css">
  ...
  <link rel="stylesheet" href="css/galeriasfechas.css">
...
">
          <ul>
            ...
            <li>
              <button type="button" class="btnLogin" data-bs-toggle="modal" data-bs-target="#staticBackdropLogin">
                <span class="text-white fw-bold d-none d-md-block d-lg-block d-xl-block d-xxl-none">Regístrate aqui</span>
                <i class="fa fa-user d-none d-xxl-block" aria-hidden="true"></i>
              </button>
  ...
  <main class="container  " style="margin-top: 188px;">